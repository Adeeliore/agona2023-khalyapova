...
function logPerson(person, index) {
    ...
    var dateDetails = dateWizard.dateDetails(person.registered);
    var registeredAt = "".concat(dateDetails.date, ".").concat(dateDetails.month, ".").concat(dateDetails.year, " ").concat(dateDetails.hours, ":").concat(dateDetails.minutes);
